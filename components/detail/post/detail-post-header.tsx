...
const DetailPostHeader: React.FC<DetailPostHeaderProps> = ({ title }) => {
  ...
  return (
    <header className="border-y-1 sticky top-0 z-40 border-black/5 bg-black shadow-sm shadow-gray-300 backdrop-blur-lg">
      <nav
        className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4"
        aria-label="Global"
      >
        <div className="flex flex-none items-center justify-start pr-6">
          <SharedBackButton />
        </div>
