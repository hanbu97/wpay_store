          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <Input
                    className="w-full border border-white min-w-0 appearance-none rounded-md border-0 bg-black px-3 py-1.5 text-base text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:w-64 sm:text-sm sm:leading-6 xl:w-full"
